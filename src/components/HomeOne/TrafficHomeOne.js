  ...
  return (
    <section className="appie-traffic-area pt-140 pb-180">
        ...
        <div className="row">
          <div className="col-lg-7">
            <div className="appie-traffic-title">
              <span>Traffic</span>
              <h3 className="title">
                All transaction should be made on the site.
              </h3>
              <p>
                C-rentals advises you not to pay to any individuals except it's
                from a valid agent sourse.
              </p>
            </div>
            <div className="row">
              ...
              <div className="col-lg-6 col-md-6">
                <div className="appie-traffic-service item-3">
                  ...
                  <p>Check in to your hostel after Payment.</p>
                </div>
              </div>
              <div className="col-lg-6 col-md-6">
      ...
      <div className="traffic-thumb ">
        <img
          style={{ width: "846", height: "677px", objectFit: "contain" }}
